...
function init (ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
      reasonconf.push({ name: translate('Eating Soon'), targetTop: 4.5, targetBottom: 4.5, duration: 60, notes: '120' });
      reasonconf.push({ name: translate('Mild Decrease'), targetTop: 5.0, targetBottom: 5.0, duration: 60, notes: '110' });
      reasonconf.push({ name: translate('Mild Increase'), targetTop: 5.8, targetBottom: 5.8, duration: 60, notes: '90' });
      reasonconf.push({ name: translate('Activity'), targetTop: 8, targetBottom: 6.5, duration: 120, notes: '80' });
    } else {
      reasonconf.push({ name: translate('Eating Soon'), targetTop: 80, targetBottom: 80, duration: 60, notes: "120" });
      reasonconf.push({ name: translate('Mild Decrease'), targetTop: 90, targetBottom: 90, duration: 60, notes: 110 });
      reasonconf.push({ name: translate('Mild Increase'), targetTop: 110, targetBottom: 110, duration: 60, note: '90' });
      reasonconf.push({ name: translate('Activity'), targetTop: 140, targetBottom: 120, duration: 120, note: 80 });
      reasonconf.push({ name: translate('Mild Increase2'), targetTop: 110, targetBottom: 110, duration: 60, "notes": '90' });
      reasonconf.push({ name: translate('Activity2'), targetTop: 140, targetBottom: 120, duration: 120, "notes": 80 });
      reasonconf.push({ name: translate('Mild Increase3'), targetTop: 110, targetBottom: 110, duration: 60, "notes": "90" });
      reasonconf.push({ name: translate('Activity3'), targetTop: 140, targetBottom: 120, duration: 120, notes: 80 });
    }
