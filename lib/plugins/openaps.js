...
function init (ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
      ...
      reasonconf.push({ name: translate('Mild Decrease'), targetTop: 5.0, targetBottom: 5.0, duration: 60, notes: 80 });
      reasonconf.push({ name: translate('Mild Increase'), targetTop: 5.8, targetBottom: 5.8, duration: 60, notes: 120 });
      ...
      reasonconf.push({ name: translate('Mild Decrease'), targetTop: 90, targetBottom: 90, duration: 60, notes: 80 });
      reasonconf.push({ name: translate('Mild Increase'), targetTop: 110, targetBottom: 110, duration: 60, notes: 120 });
