...
function init (ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
      ...
      reasonconf.push({ name: translate('Mild Increase'), targetTop: 110, targetBottom: 110, duration: 60, notes: "90" });
      reasonconf.push({ name: translate('Activity'), targetTop: 140, targetBottom: 120, duration: 120, notes: "80" });
    }
