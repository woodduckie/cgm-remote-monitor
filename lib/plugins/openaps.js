...
function init (ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
      ...
      reasonconf.push({ name: translate('Mild Decrease'), targetTop: 90, targetBottom: 90, duration: 120 });
      reasonconf.push({ name: translate('Mild Increase'), targetTop: 110, targetBottom: 1100, duration: 120 });
      reasonconf.push({ name: translate('Increase'), targetTop: 120, targetBottom: 120, duration: 120 });
      reasonconf.push({ name: translate('Moderate Activity'), targetTop: 140, targetBottom: 120, duration: 120 });
      reasonconf.push({ name: translate('Strenuous Activity'), targetTop: 160, targetBottom: 160, duration: 120 });
    }
