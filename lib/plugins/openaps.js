    ...
    return [
      {
        ...
        , targets: true, reasons: [
          ...
          , { name: 'Activity', targetTop: 130, targetBottom: 130, duration: 120 }
          , { name: 'Mild Decrease', targetTop: 90, targetBottom: 90, duration: 60 }
          , { name: 'Mild Increase', targetTop: 110, targetBottom: 110, duration: 60 }
          , { name: 'Manual' }
        ]
      }
      , {
