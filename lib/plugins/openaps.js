...
function init (ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
	    ...
	    reasonconf.push({ name: translate('Mild Decrease'), targetTop: 5.0, targetBottom: 5.0, duration: 60 });
	    reasonconf.push({ name: translate('Mild Increase'), targetTop: 5.8, targetBottom: 5.8, duration: 60 });
    	reasonconf.push({ name: translate('Activity'), targetTop: 7.2, targetBottom: 7.2, duration: 120 });
    } else {
    	reasonconf.push({ name: translate('Eating Soon'), targetTop: 80, targetBottom: 80, duration: 60 });
	    reasonconf.push({ name: translate('Mild Decrease'), targetTop: 90, targetBottom: 90, duration: 60 });
	    reasonconf.push({ name: translate('Mild Increase'), targetTop: 110, targetBottom: 110, duration: 60 });
    	reasonconf.push({ name: translate('Activity'), targetTop: 130, targetBottom: 130, duration: 120 });   
    }
